...
list_name_activity_notification=["tên gì","tên là gì","tên hoạt động là gì","tên hoạt động","tên các hoạt động","tên những hoạt động","tên một số hoạt động","tên vài hoạt động"] #check lai
